...
struct MockData {
    ...
    static func getMockStories(name: String) -> [StoryModel] {
        [
            StoryModel(
    ...
    static let storyVideos = ["https://drive.usercontent.google.com/download?id=1pooqb9sW2HNiE9SVxqY2FWjM49mF6B8L&export=download",
